...
const BotonPurple = class {
    ...
    render() {
        return (index.h("button", { key: 'bc2a69834ef7068aa507c0a6ff8fb8c1be851c2f', class: `btn btn-${this.color}`, disabled: this.disabled, onClick: this.handleClick, onMouseMove: this.handleMouseMove, style: {
                '--x': `${this.mouseX}px`,
                '--y': `${this.mouseY}px`
            } }, this.icon ? (index.h("span", { class: "icon-circle" }, this.renderIcon())) : null, index.h("span", { key: 'aac40064a27884ca23605a05f0be7d9a1ebefb77', class: "btn-text" }, this.texto)));
    }
};
