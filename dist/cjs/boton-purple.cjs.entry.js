...
const BotonPurple = class {
    ...
    render() {
        return (index.h("button", { key: '1e1dc579348dfea834777cb4cdb8ed19d47fff8f', class: `btn btn-${this.color}`, disabled: this.disabled, onClick: this.handleClick, onMouseMove: this.handleMouseMove, style: {
                '--x': `${this.mouseX}px`,
                '--y': `${this.mouseY}px`
            } }, this.icon ? (index.h("span", { class: "icon-circle" }, this.renderIcon())) : null, index.h("span", { key: 'a9d2a9c7ab501aa3edb54ad00bf924c9219731ad', class: "btn-text" }, this.texto)));
    }
};
