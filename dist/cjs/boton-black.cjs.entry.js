...
const BotonBlack = class {
    ...
    render() {
        return (index.h("button", { key: '5b5a7649b8a06fbd128d861b12ff6bc720700e01', class: `btn btn-${this.color}`, disabled: this.disabled, onClick: this.handleClick, onMouseMove: this.handleMouseMove, style: {
                '--x': `${this.mouseX}px`,
                '--y': `${this.mouseY}px`
            } }, this.icon ? (index.h("span", { class: "icon-circle" }, this.renderIcon())) : null, index.h("span", { key: '71c8fb4193064780385355842ec5eeddc46a0375', class: "btn-text" }, this.texto)));
    }
};
