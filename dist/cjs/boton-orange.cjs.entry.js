...
const BotonOrange = class {
    ...
    render() {
        return (index.h("button", { key: '6f93057fa6251c6144ad1f82538ac2a1a0e1d9a5', class: `btn btn-${this.color}`, disabled: this.disabled, onClick: this.handleClick, onMouseMove: this.handleMouseMove, style: {
                '--x': `${this.mouseX}px`,
                '--y': `${this.mouseY}px`
            } }, this.icon ? (index.h("span", { class: "icon-circle" }, this.renderIcon())) : null, index.h("span", { key: '250263e1def40f237a7bfd0e9dc3d35f8b682880', class: "btn-text" }, this.texto)));
    }
};
