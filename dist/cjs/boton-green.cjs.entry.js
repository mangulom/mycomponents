...
const BotonGreen = class {
    ...
    renderIcon() {
        if (this.icon === 'save') {
            return (index.h("svg", { viewBox: "0 0 448 512", fill: "currentColor" }, index.h("path", { d: "M433.94 129.94l-83.88-83.88A48 48 0 0 0 316.12 32H48A48 48 0 0 0 0 80v352a48 48 0 0 0 48 48h352a48 48 0 0 0 48-48V163.88a48 48 0 0 0-14.06-33.94zM224 416a64 64 0 1 1 64-64a64 64 0 0 1-64 64zm96-304v64a16 16 0 0 1-16 16H80a16 16 0 0 1-16-16V80a16 16 0 0 1 16-16h224a16 16 0 0 1 11.31 4.69L316.69 92a16 16 0 0 1 3.31 9z" })));
        }
        return null;
    }
    render() {
        return (index.h("button", { key: '521c60c50cc060af306312b999d6eabac0d52f88', class: `btn btn-${this.color}`, disabled: this.disabled, onClick: this.handleClick, onMouseMove: this.handleMouseMove, style: {
                '--x': `${this.mouseX}px`,
                '--y': `${this.mouseY}px`
            } }, this.icon ? (index.h("span", { class: "icon-circle" }, this.renderIcon())) : null, index.h("span", { key: '2a17e958f77b16ce03f95d898c6e9d7209167f64', class: "btn-text" }, this.texto)));
    }
};
