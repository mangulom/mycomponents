...
const BotonPrimary = class {
    ...
    render() {
        return (index.h("button", { key: 'c300bb3a6f9c9a348a5641fe0780a4936aa92a22', class: `btn btn-${this.color}`, disabled: this.disabled, onClick: this.handleClick, onMouseMove: this.handleMouseMove, style: {
                '--x': `${this.mouseX}px`,
                '--y': `${this.mouseY}px`
            } }, this.icon ? (index.h("span", { class: "icon-circle" }, this.renderIcon())) : null, index.h("span", { key: 'ad6762548f86e545f8ca04765c9e3a212d9a6e39', class: "btn-text" }, this.texto)));
    }
};
