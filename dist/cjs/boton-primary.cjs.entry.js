...
const BotonPrimary = class {
    ...
    render() {
        return (index.h("button", { key: '4f841ad6cc9236f0c82dad486a1f2c8ff46505c4', class: `btn btn-${this.color}`, disabled: this.disabled, onClick: this.handleClick, onMouseMove: this.handleMouseMove, style: {
                '--x': `${this.mouseX}px`,
                '--y': `${this.mouseY}px`
            } }, this.icon ? (index.h("span", { class: "icon-circle" }, this.renderIcon())) : null, index.h("span", { key: '7c4a548796a291fe9a316272125ba11229ef347e', class: "btn-text" }, this.texto)));
    }
};
