...
const BotonPrimary = class {
    ...
    render() {
        return (index.h("button", { key: 'c6bea8eff6700064cc97aeeeccd9a91a2506a61e', class: `btn btn-${this.color}`, disabled: this.disabled, onClick: this.handleClick, onMouseMove: this.handleMouseMove, style: {
                '--mx': `${this.mouseX}px`,
                '--my': `${this.mouseY}px`
            } }, this.texto));
    }
