...
const BotonPrimary = class {
    ...
    render() {
        return (index.h("button", { key: '4d95a0dbb9b9706218c55d805957bb915e4d2527', class: `btn btn-${this.color}`, disabled: this.disabled, onClick: this.handleClick, onMouseMove: this.handleMouseMove, style: {
                '--x': `${this.mouseX}px`,
                '--y': `${this.mouseY}px`
            } }, this.texto));
    }
